...
from app.middleware.audio_upload_limit import AudioUploadLimitMiddleware
...
def create_application() -> FastAPI:
    ...
    application = FastAPI(
        ...
        version="0.1.0",
        description="Platform API for voiceup",
        docs_url="/docs",
    ...
    application.add_middleware(
        AudioUploadLimitMiddleware,
        path=f"{settings.api_prefix}/recordings",
        maximum=settings.audio_max_bytes,
    )
    application.add_middleware(
        CORSMiddleware,
