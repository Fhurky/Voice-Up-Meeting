...
export const baseUrl = (process.env.APP_E2E_BASE || 'http://localhost:8080').replace(/\/$/, '');
export const username = process.env.APP_E2E_SUPER_ADMIN_USER || process.env.@@ENV_PREFIX@@SUPER_ADMIN_USER;
export const password = process.env.APP_E2E_SUPER_ADMIN_PASS || process.env.@@ENV_PREFIX@@SUPER_ADMIN_PASS;
