...
- [Proje planı ve mimari](docs/PROJECT_PLAN.md)
- [Kaynaklı model karşılaştırması ve lisanslar](docs/MODEL_RESEARCH.md)
- [5/10/20/50 kişilik gerçek ses değerlendirme planı](docs/EVALUATION_PLAN.md)
- [Gerçek model denemesi ve mevcut doğrulama durumu](docs/VALIDATION.md)
